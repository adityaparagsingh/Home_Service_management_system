...
class ContactUsWindow:
    def __init__(self,root):
        ...
        lbl_title2=Label(self.root,text="Reach Us",font=("times new roman",30,),bg="black",fg="gold",bd=4,relief=RAISED,cursor="circle")
...
#------------------------Wtitten Part--------------------------
        lbl_title2=Label(self.root,text="For Contacting Us \n Call us on 123456 , 987654 \n Mail us at adityahomeservices@gmail.com",font=("times new roman",30,),bg="black",fg="gold",bd=4,relief=RAISED,cursor="circle")
